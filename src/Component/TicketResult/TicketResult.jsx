...
const TicketResult = ({ progress, handeleComplete, resolve }) => {
    ...
    return (
        <div className='bg-gray-200 p-4'>
            <h1 className='text-2xl pb-4 font-bold text-black '  >Active Tickets </h1>
                    ...
                    progress.map(progres =>
                        <div className='bg-gray-300  p-4 text-black rounded-md shadow-md '>
                            <div className="">
                                ...
                                <button onClick={() => handeleComplete(progres)} className="btn btn-success btn-block text-white text-lg">Complete</button>
                            </div>
                        </div>
                    )
                }
